...
public class Strings {
	...
	public static void main(String[] args) {
		System.out.println(Strings.isSucc("來測試", "測試", Strings.ChineseLike));
		System.out.println(Strings.isSucc(" This  is a book", "is a book",
																			Strings.EnglishLike));
		System.out.println(Strings.getN(" This  is a  book", Strings.EnglishLike));
		System.out.println(Strings.getSubNGram(" This  is a  book",
																					 2, 4, Strings.EnglishLike));
		System.out.println(Strings.getSubNGram(" This",
																					 1, 1, Strings.EnglishLike));
		System.out.println(Strings.condenseSpace("  This  is   ,    a  book   "));
		System.out.println(Strings.inverse("來測試  This  is   ,    a  book   "));
		System.out.println(Strings.inverse("This is a book", Strings.EnglishLike));
		System.out.println(Strings.indexOf("This is a book", " ", 7, 2));
	}
}